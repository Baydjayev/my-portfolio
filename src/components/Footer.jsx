...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-r from-deep-black to-gray-900 text-white">
          ...
          <div className="grid md:grid-cols-3 gap-8 items-center">
            ...
            >
              {socialLinks.map((social, index) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="p-3 bg-sky-blue/20 rounded-full hover:bg-sky-blue/30 transition-colors duration-300 group"
                  aria-label={social.name}
                >
                  <div className="text-sky-blue group-hover:text-white transition-colors">
                    {social.icon}
                  </div>
                </motion.a>
              ))}
            ...
            >
              <motion.button
                ...
                className="inline-flex items-center gap-2 text-sky-blue hover:text-white transition-colors duration-300"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
