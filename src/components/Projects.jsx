      ...
      <div className="container-max">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-deep-black mb-6">
            My <span className="text-sky-blue">Projects</span>
          </h2>
          <p className="text-lg text-gray-700 max-w-3xl mx-auto">
            Here are some of my recent projects that showcase my skills in Telegram bot development, 
            web applications, and full-stack solutions.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <motion.div
              ...
              className="card-hover bg-white rounded-xl shadow-lg overflow-hidden border border-sky-blue/10"
            >
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.technologies.map((tech, techIndex) => (
                    <span
                      key={techIndex}
                      className="px-3 py-1 bg-sky-blue/10 text-sky-blue text-sm rounded-full border border-sky-blue/20"
                    >
                      {tech}
                    </span>
                  ))}
